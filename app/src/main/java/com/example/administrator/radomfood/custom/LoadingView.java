package com.example.administrator.radomfood.custom;
...
public class LoadingView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (colorList.size() == 0) {
            mColors = new int[]{ContextCompat.getColor(getContext(), R.color.colorAccent), ContextCompat.getColor(getContext(), R.color.colorAccentDark)};
        } else {
